...
<head>
    ...
    <title>A 4 pattes de chez vous</title>
    <link rel="stylesheet" href="../node_modules/bootstrap/dist/css/bootstrap.css">
    <link rel="stylesheet" href="../assets/style/style.css">

    <!-- icones fontawesome -->
    <script src="https://kit.fontawesome.com/e7bc07dee6.js" crossorigin="anonymous"></script>
</head>
...
<body class="body d-flex flex-column vh-100">
    <header class="header d-flex flex-column justify-content-center text-center shadow">
        ...
        <p class="h2"><i class="fa-solid fa-paw"></i> Refuge havrais pour animaux <i class="fa-solid fa-paw"></i></p>
    </header>